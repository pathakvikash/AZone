  ...
  return (
    <div className=''>
      <div className='flex items-center '>
        ...
        <button
          className='absolute  left-2 transform -translate-y-1/2 bg-gray-300 rounded-full w-10 h-10 flex items-center justify-center text-gray-600'
          onClick={() => changeDeal(-1)}
        >
          &lt;
        </button>
        <button
          className='absolute  right-2 transform -translate-y-1/2 bg-gray-300 rounded-full w-10 h-10 flex items-center justify-center text-gray-600'
          onClick={() => changeDeal(1)}
        >
          &gt;
        </button>
